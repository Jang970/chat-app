...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="bg-neutral-800 text-neutral-200 h-screen w-screen flex flex-col items-center justify-center gap-y-10">
        {user ? (
          <div className="w-full h-full flex flex-col">
            <nav className="flex w-full p-4 bg-slate-600 justify-center items-center">
